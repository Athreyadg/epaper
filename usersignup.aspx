                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label>User ID</label>
                                <div class="">
                                    <asp:TextBox class="form-control" ID="TextBox12" runat="server" placeholder="User ID"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="">
                                    <asp:TextBox class="form-control" ID="TextBox13" runat="server" placeholder="Password" TextMode="Password"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                           ...
                           <div class=" d-grid gap-2 mx-auto">
                              <asp:Button href="usersignup.aspx" class="btn btn-primary btn-block btn-lg" ID="Button1" runat="server" Text="Register" OnClick="Button1_Click" />
                           </div>
                            

                            <%--<div class=" d-grid gap-2">
                                <a href="usersignup.aspx" class="btn btn-info btn-lg">
