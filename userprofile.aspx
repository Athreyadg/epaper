         ...
         <div class="col-md-5">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           ...
                           <asp:Label class="badge rounded-pill bg-success" ID="Label1" runat="server" Text="Your status">Active</asp:Label>
                        </center>
                     </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                     <div class="input-group d-grid gap-8 mx-auto">
                        <center>
                           <div class="form-group">
            ...
            <div class="card">
               <div class="card-body">
                  <div class="row">
                     <div class="col">
                        <center>
                           <img width="75px" src="imgs/books1.png"/>
                        </center>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col">
                        <center>
                           <h4>Papers Viewed</h4>
                           <asp:Label class="badge rounded-pill bg-info" ID="Label2" runat="server" Text="papers info"></asp:Label>
                        </center>
                     </div>
                  </div>
                  <div class="row">
